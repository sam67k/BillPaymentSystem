...
def Load():
    ...
    def NumberValidTest(i2):
        Pattern = re.compile("(0/+92)?[00-49][0-9]{9}")
    ...
    def Process():
        ...
        if (NumberValidTest(i2)):
            ...
            condition = False
        while(condition != True):
            print("\nNumber not Valid Pakistani Cell Number")
...
- [ElectricityBillRecords.csv](ElectricityBillRecords.csv)
- [GasBillRecords.csv](GasBillRecords.csv)
- [MobileLoadRecords.csv](MobileLoadRecords.csv)
- [TelephoneBillRecords.csv](TelephoneBillRecords.csv)
- [WaterBillRecords.csv](WaterBillRecords.csv)
